        ...
        <div class="row mb-3 text-info">
            <form class="form-inline">
                <div class="form-group">
                    <label for="filter" class="lead mr-3"><i class="fa fa-search mr-2"
                            aria-hidden="true"></i><strong>BUSCAR CLIENTE:</strong></label>
                    <input type="text" name="filter" id="filter" class="col-sm-12 form-control"
                        placeholder="Nome / Razão Social / CPF / CNPJ">
                </div>
            </form>
        </div>
        <div class="row">
